clear all;
root = 'D:\FODMAP_fMRI\FOR_SECOND_LEVEL\fructans_glucose\'; 
cd(root);
...
matlabbatch{1}.spm.stats.factorial_design.dir = {'D:\FODMAP_fMRI\SECOND_LEVEL\fructans_glucose\pat_v_con\'};
...
matlabbatch{3}.spm.stats.con.consess{2}.fcon.name = 'controls interaction efect';
%%
...
cd 'D:\FODMAP_fMRI\SECOND_LEVEL\fructans_glucose\pat_v_con\';
eval('save batch_oneway_ANOVA_2nd_level_fructans_glucose_pat_v_con.mat matlabbatch');%save batch job and rename
cd(root);
spm_jobman('initcfg');
